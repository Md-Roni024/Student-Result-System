...
<body class="bg-dark">
  ...
  <main id="main" >
  		...
  		<div class="align-self-center w-100"style="margin-top: 70px; ">
		<h4 class="text-white text-center"><b>Student Result System</b></h4>
  		<div id="login-center" class="bg-dark row justify-content-center">
  			<div class="card col-md-4">
  				<div class="card-body">
  					<form id="login-form" class="control-label text-dark">
